...
function getPetPersistentEffects()
  ...
  sb.logInfo("Current Effects %s", effects)
  sb.logInfo("Current Effects %s", status.getPersistentEffects("armor"))
  sb.logInfo("Current Effects %s", sb.printJson(effects, true))
  return effects
end
