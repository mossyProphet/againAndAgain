...
function EnergyOrb:init()
  ...
  minionBonus = status.stat("minionStatsBonus")

  self.cooldownTimer = self.cooldownTime / minionBonus
end
...
function EnergyOrb:fire()
  for i = 1, minionBonus do
    ...
    aimVector[1] = aimVector[1] * mcontroller.facingDirection() + (i-minionBonus*0.5)*(1/minionBonus)
    local params = {
