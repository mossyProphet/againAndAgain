...
function Weapon:damageSource(damageConfig, damageArea, damageTimeout)
  if damageArea then
    modifiersFromUpgrades = self.modifiersFromUpgrades or 1
    ...
    local damage = damageConfig.baseDamage * self.damageLevelMultiplier * activeItem.ownerPowerMultiplier() * modifiersFromUpgrades
