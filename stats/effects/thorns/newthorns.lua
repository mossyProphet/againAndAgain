function init()
  ...
  self.minionBonus = config.getParameter("minionBonus")
  ...
  status.modifyResource("minionSlotsCount", self.minionBonus)
end
...
function uninit()
  status.consumeResource("minionSlotsCount", self.minionBonus)
end